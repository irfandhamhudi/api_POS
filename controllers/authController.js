...
const loginUser = async (req, res) => {
  try {
    ...
    if (user.disabled) {
      return res.status(403).json({ success: false, message: 'This account has been disabled. Please contact Administrator.' });
    }
...
export { loginUser, logoutUser, getMe, updateProfile, updatePassword };
